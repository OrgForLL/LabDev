        ...
        <table cellpadding="0" cellspacing="0" class="mytable" style="margin:auto">
            ...
            <tbody >
                ...
                <tr>
                    ...
                    <td colspan="3">成品纬密</td><td colspan="5">{{form.cpwm}}</td>
                ...
                <tr>
                    ...
                    <td colspan="3">坯布版单号</td><td colspan="5">{{form.pbdh}}</td>
                    <td colspan="3">成品克重(g/m)</td><td colspan="5">{{form.kz}}</td>
                    <td colspan="3">合作类型</td><td colspan="5">{{form.hzlx | handlehzlx(hzlx)}}</td>
                </tr>
                ...
                <tr>
                	...
                	<td colspan="4">百米用纱量</td>
                	<td colspan="6">纱线要求</td>
                	<td colspan="6">织造要求</td>
                	<td colspan="6">特别注意事项</td>
                </tr>
                <tr>
                	<td colspan="3">上机经密(根/英寸)</td><td colspan="4">{{form.yq.jm}}</td>
                ...
                <tr>
                	<td colspan="3">上机纬密(根/英寸)</td><td colspan="4">{{form.yq.wm}}</td>
                </tr>
                 <tr>
                	<td colspan="3">上机幅宽(英寸)</td><td colspan="4">{{form.yq.fk}}</td>
                </tr>
    ...
    methods:{
        init: function(){
            ...
            .then((response)=>{
                ...
                //获取坯布信息
                _this.hzlx = response[4].data.data;
                _this.loading=false;
            })
            	}
    },
